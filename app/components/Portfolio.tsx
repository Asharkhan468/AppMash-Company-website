    ...
    <section id="portfolio" className="relative bg-neutral2 w-full flex flex-col items-center overflow-hidden pt-6 sm:pt-8 pb-8 sm:pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="flex flex-wrap justify-between items-center mt-6">
          ...
          <button className=" text-primary2  px-4 sm:px-6 py-2 rounded-md text-xs sm:text-sm font-medium hover:text-primary2 border border-primary2 transition mt-10 sm:mt-0">
            See All
          </button>
        </div>

        {/* Cards Section (Aligned with suggestion buttons) */}
