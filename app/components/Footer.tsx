...
function Footer() {
  return (
<footer className="bg-gradient-to-b from-neutral2/95 to-primary2 text-white py-10 sm:py-12 border-t border-secondary2 rounded-t-2xl">
  {/* Top Heading Section */}
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
    ...
    <div className="flex flex-col items-center md:items-start text-center md:text-left">
      <Image src={logo} alt="Logo" className="w-28 sm:w-32 md:w-40 mb-4 drop-shadow-lg" />

      {/* Social Icons Grid */}
      <div className="grid grid-cols-2 gap-4 mt-4">
        <div className="flex flex-col gap-2 sm:gap-3">
          <a href="#" className="flex items-center gap-2 hover:text-primary2 transition-colors text-xs sm:text-sm">
    ...
    {/* Technologies */}
    <div className="text-center md:text-left">
      <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">Technologies</h3>
      <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-gray-300">
        <li>React.js</li>
        <li>Next.js</li>
        <li>Node.js</li>
    ...
    {/* UI Design */}
    <div className="text-center md:text-left">
      <h3 className="text-base sm:text-lg font-semibold mb-3 sm:mb-4">UI Design</h3>
      <ul className="space-y-1.5 sm:space-y-2 text-xs sm:text-sm text-gray-300">
        <li>Define Ideas</li>
