...
function Blog() {
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
      {/* Card */}
      {[ 
        { image: image1, author: "Abdullah", title: "Building a Modern Web App", desc: "Learn the step-by-step process of creating a modern web application using Next.js and Tailwind CSS." },
        { image: image2, author: "Muzammil", title: "Mastering Tailwind CSS", desc: "Discover how to design fast, responsive, and beautiful UIs with Tailwind CSS in record time." },
        { image: image3, author: "Haider Ali", title: "Improve Your JavaScript Skills", desc: "Practical tips and tricks to take your JavaScript skills to the next level as a modern web developer." },
      ].map((blog, index) => (
        <div key={index} className="bg-neutral1 rounded-lg shadow-lg overflow-hidden hover:shadow-2xl transition duration-300 h-[30rem] flex flex-col">
          <Image
            src={blog.image}
            alt={blog.title}
